...
public class ScannerEx1 {
    public static void main(String[] args) {
        ...
        * */
        ...
        // -next() / nextInt() / nextDouble() 등을 작성한 이후에 nextLine() 을 작성해야하는 상황이 오면 nextLine()구문을 미리 한 번 작성하기
